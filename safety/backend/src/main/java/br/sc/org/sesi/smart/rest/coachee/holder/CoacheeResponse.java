...
public class CoacheeResponse implements Serializable {
	...
	private List<?> listaUsuarioTeste;
	...
	public List<?> getListaUsuarioTeste() {
		return listaUsuarioTeste;
	}
	public void setListaUsuarioTeste(List<?> listaUsuarioTeste) {
		this.listaUsuarioTeste = listaUsuarioTeste;
	}
