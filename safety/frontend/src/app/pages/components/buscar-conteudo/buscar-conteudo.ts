...
import { BuscarConteudoService } from './buscar-conteudo.service';
import { Subject } from 'rxjs/Subject';
import 'style-loader!./buscar-conteudo.scss';
@Component({
  selector: 'buscar-conteudo',
          ...
          <input type="text" id ="ceSearch" class="form-control palavraChave"  name="ceSearch"  [(ngModel)]="estrategiaSearch" >
           ...
           <!--(keyup)="searchTerm$.next($event.target.value)""-->
              ...
              <div *ngIf="Categoria == 5">
                ...
                `,
  providers: [BuscarConteudoService]
})

export class BuscarConteudo {
  ...
  constructor(private searchService: BuscarConteudoService) {
